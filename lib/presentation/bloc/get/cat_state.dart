...
class CatState extends Equatable {
  ...
  const CatState({this.images, this.fact, this.isLoading = false, this.error, this.currentPage = 0, this.hasReachedMax = false, this.searchQuery, this.breedIds});

  @override
  List<Object?> get props => [images, fact, isLoading, error, currentPage, hasReachedMax, searchQuery, breedIds];
  final String? searchQuery;
  final String? breedIds;
